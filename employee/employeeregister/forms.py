...
class employeeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'pregunta1': forms.TextInput(attrs={'class': 'form-control', 'id': 'pregunta1', 'placeholder': ''}),
            'pregunta2': forms.TextInput(attrs={'class': 'form-control', 'id': 'pregunta2', 'placeholder': ''}),
            'pregunta3': forms.TextInput(attrs={'class': 'form-control', 'id': 'pregunta3', 'placeholder': ' '}),
            'pregunta4': forms.TextInput(attrs={'class': 'form-control', 'id': 'pregunta4', 'placeholder': ' '}),
            'pregunta5': forms.TextInput(attrs={'class': 'form-control', 'id': 'pregunta5', 'placeholder': ''}),
            'pregunta6': forms.TextInput(attrs={'class': 'form-control', 'id': 'pregunta6', 'placeholder': ''}),
        }
